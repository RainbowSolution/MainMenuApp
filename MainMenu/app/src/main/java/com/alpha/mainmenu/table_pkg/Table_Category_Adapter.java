...
public class Table_Category_Adapter extends RecyclerView.Adapter<Table_Category_Adapter.MyViewHolder> {
        public ArrayList<HistoryData> searchList;
        Context context;
        private LayoutInflater mInflater;

        public Table_Category_Adapter(Context activity, ArrayList<HistoryData> List) {
            searchList = List;
            context = activity;
        }
        ...
        public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.table_fragment_cat_row, parent, false);
...
//            holder.tv_productname.setText(detail.getOrdername());
            ...
            holder.btn_restaurant.setOnClickListener(new View.OnClickListener() {
                @Override
