...
public class Patient_Book_Appointment_Another_Activity extends AppCompatActivity  implements View.OnClickListener{
    ImageView iv_back;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.patient_book_appointment_another);
        ...
        tv_title.setText("Book For Another");
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btn_booknow:
                startActivity(new Intent(Patient_Book_Appointment_Another_Activity.this, Patient_Confirm_Booking_Activity.class));
                overridePendingTransition(R.anim.slide_in_left, R.anim.slide_out_left);
                break;


            case R.id.rl_notification:
                startActivity(new Intent(Patient_Book_Appointment_Another_Activity.this, Notification_Activity.class));
                overridePendingTransition(R.anim.slide_in_left, R.anim.slide_out_left);
                break;
