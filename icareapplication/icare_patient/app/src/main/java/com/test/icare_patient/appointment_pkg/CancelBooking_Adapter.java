...
public class CancelBooking_Adapter extends RecyclerView.Adapter<CancelBooking_Adapter.ViewHolder> {
    private Context context;
    private OnClick onClick;

    public CancelBooking_Adapter(Context context, OnClick onClick) {
